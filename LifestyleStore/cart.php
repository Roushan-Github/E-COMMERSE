        ...
        <div>
                ...
                <table class="table table-bordered table-striped">
                    <tbody>
                       ...
                       <?php $counter=$counter+1;}?>
                        <tr>
                            <th></th><th>Total</th><th>Rs <?php echo $sum;?>/-</th><th><a href="success.php?id=<?php echo $user_id?>" class="btn btn-primary">Confirm Order with COD</a></th>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <footer class="footer">
               ...
               <center>
                   ...
                   <p>This website is developed by Roushan Kumar</p>
               </center>
               </div>
           </footer>
        </div>
